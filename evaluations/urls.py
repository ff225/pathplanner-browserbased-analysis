...
urlpatterns = [
    ...
    path('pollen/', get_pollen, name='pollen'),
    ...
    path('pois', get_pois_in_bbox, name='pois_no_slash'),
    path('pois/', get_pois_in_bbox, name='pois'),
    path('street_graph', get_street_graph, name='street_graph_no_slash'),
    path('street_graph/', get_street_graph, name='street_graph'),
    path('env_score/', get_env_score, name='env_score'),
    path('backend_astar/', backend_astar_route, name='backend_astar'),
